...
total_count (study, 'amenities', 'count', possible_vals)
...
x1.groupby("Superhost", as_index=True)['review_scores_rating','review_scores_accuracy','review_scores_checkin', 
...
superhost_data.groupby(['neighbourhood_cleansed']).mean()['price'].sort_values()
